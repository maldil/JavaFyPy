/*
 * Initial code taken from Charlie Nutter's org.jruby.org.jpp.util.CodegenUtils.
 */
        ...
        if (n.isArray()) {
            ...
            if (n.isPrimitive()) {
                if (n == Byte.TYPE) {
                    ...
                    throw new RuntimeException("Unrecognized type in org.jpp.compiler: " + n.getName());
                }
            } else {
                return "[" + ci(n);
            }
