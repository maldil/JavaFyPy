...
import org.jpp.heart.buffer.SimpleStringBuffer;
...
import org.jpp.util.FilenoUtil;
 ...
 * <code>_fileio.PyFileIO</code>, the purely Java-accessible {@link org.jpp.heart.io.IOBase} (both
 * Philip Jenvey's work), and the Python implementation in <code>Lib/_pyio</code>. We do not simply
 * delegate to the implementation in {@link org.jpp.heart.io} because of the need to override
...
public class PyIOBase extends PyObject implements FinalizableBuiltin, Traverseproc {
     ...
     * org.jpp.modules/_io/iobase.c. That function checks for the *existence* of an attribute
