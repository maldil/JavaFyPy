...
public class _imp {
    ...
    public static int exec_builtin(PyObject mod) {
        ...
        Class c = Py.findClassEx(classname, "builtin org.jpp.modules");
        if (c != null) {
            try {
     ...
     * thread-safety when importing org.jpp.modules.
     *
     */
    @ExposedFunction
    ...
    /**
     * Returns the list of file suffixes used to identify extension org.jpp.modules.
     */
    @ExposedFunction
