 ...
 * introduction of a traverseproc-mechanism (c.f. {@link org.jpp.heart.Traverseproc})
 ...
 * {@link org.jpp.heart.finalization.FinalizeTrigger}s, Jython has full control about
...
public class gc {
     ...
     * {@link org.jpp.heart.Traverseproc}).
     ...
     * {@link org.jpp.heart.Traverseproc} and
     * are not marked as {@link org.jpp.heart.Untraversable}.
     ...
     * {@link org.jpp.heart.Untraversable}.
     * </p>
     * <p>
     ...
     * that neither implements {@link org.jpp.heart.Traverseproc}
     * nor is marked as {@link org.jpp.heart.Untraversable} (even if
     ...
     * {@link org.jpp.heart.Traverseproc},
     * nor are annotated with the {@link org.jpp.heart.Untraversable}-annotation.
     * </p>
     * <p>
     ...
     * traversed that neither implements {@link org.jpp.heart.Traverseproc},
     * nor is annotated with the {@link org.jpp.heart.Untraversable}-annotation.
     *
     * @see #setJythonGCFlags(short)
     * @see #getJythonGCFlags()
     * @see #addJythonGCFlags(short)
    ...
    /**
     * Works like {@link org.jpp.heart.Py#writeDebug(String, String)},
     * but prints to {@link org.jpp.heart.Py#writeDebug(String, String)}
     ...
     * @see org.jpp.heart.Py#writeDebug(String, String)
     */
...
//--------------Finalization preprocess/postprocess section--------------------
     ...
     * {@link org.jpp.heart.finalization.FinalizeTrigger}s;
...
//--------------end of Monitoring section--------------------------------------
     ...
     * Suppress warnings for PyObjects that neither implement {@link org.jpp.heart.Traverseproc} nor
     * are marked as {@link org.jpp.heart.Untraversable}.<br>
     * {@link #USE_PY_WRITE_DEBUG} - uses {@link org.jpp.heart.Py#writeDebug(String, String)} for
     ...
     * {@link org.jpp.heart.finalization.FinalizeTrigger}.
     */
     ...
     * Throws {@link org.jpp.heart.Py#NotImplementedError}.
     *
     * @throws org.jpp.heart.Py.NotImplementedError
     */
    ...
    */
    ...
    /**
     * Does its best to traverse the given {@link org.jpp.heart.PyObject}
     * {@code ob}. It exploits both
     * {@link org.jpp.heart.Traverseproc#traverse(Visitproc, Object)} and
     * {@link org.jpp.heart.TraverseprocDerived#traverseDerived(Visitproc, Object)}.
     * If {@code ob} neither implements {@link org.jpp.heart.Traverseproc} nor
     * {@link org.jpp.heart.Traverseproc} and is not annotated with
     * {@link org.jpp.heart.Untraversable}, reflection-based traversion via
     * {@link #traverseByReflection(Object, Visitproc, Object)} may be attempted
     * according to {@link #DONT_TRAVERSE_BY_REFLECTION}.
     *
     * @see org.jpp.heart.Traverseproc#traverse(Visitproc, Object)
     * @see org.jpp.heart.TraverseprocDerived#traverseDerived(Visitproc, Object)
     * @see #DONT_TRAVERSE_BY_REFLECTION
            ...
            if (! (ob instanceof Traverseproc || ob instanceof TraverseprocDerived ||
                ...
                if (((gcFlags & INSTANCE_TRAVERSE_BY_REFLECTION_WARNING) != 0) ||
                    ...
                    Py.writeWarning("gc", "The PyObject-subclass "+ob.getClass().getName()+"\n" +
                            ...
                            "javadoc of org.jpp.heart.Traverseproc.java.");
                }
            }
        }
...
//--------------Visitproc section----------------------------------------------
    ...
    private static class ReferentsFinder implements Visitproc {
        ...
        public int visit(PyObject object, Object arg) {
            ((org.jpp.heart.PySequenceList) arg).pyadd(object);
            return 0;
        }
    }
    ...
    private static class ReferrerFinder implements Visitproc {
        ...
        public int visit(PyObject object, Object arg) {
            if (((PyObject[]) arg)[0].__eq__(object).__bool__()) {
                ((org.jpp.heart.PySequenceList) ((PyObject[]) arg)[1]).pyadd(object);
            }
            return 0;
        }
    }
