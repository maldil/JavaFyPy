...
import org.jpp.heart.CodeBootstrap;
import org.jpp.heart.CodeFlag;
import org.jpp.heart.CodeLoader;
...
import org.jpp.heart.PyFunctionTable;
import org.jpp.heart.PyInteger;
import org.jpp.heart.PyLong;
import org.jpp.heart.PyObject;
import org.jpp.heart.PyRunnable;
import org.jpp.heart.PyRunnableBootstrap;
...
public class Module implements Opcodes, ClassConstants, CompilationContext {
    ...
    public Module(String name, String filename, boolean linenumbers) {
        this(name, filename, linenumbers, org.jpp.heart.imp.NO_MTIME);
    }
    ...
    public Module(String name) {
        this(name, name + ".py", true, org.jpp.heart.imp.NO_MTIME);
    }
