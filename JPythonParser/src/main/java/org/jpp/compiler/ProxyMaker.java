...
import static org.jpp.util.CodegenUtils.p;
import static org.jpp.util.CodegenUtils.sig;
...
public class ProxyMaker extends ProxyCodeHelpers implements ClassConstants, Opcodes
{
    ...
    public void addMethod(String name,
        ...
        if (!isAbstract) {
            ...
            code.invokestatic("org/python/org.jpp.compiler/ProxyMaker", "findPython",
    ...
    public void addClassDictInit() throws Exception {
        ...
        classfile.addInterface(mapClass(org.jpp.heart.ClassDictInit.class));
    ...
    protected void visitMethods() throws Exception {
        ...
        for (Class<?> iface : interfaces) {
            if (iface.isAssignableFrom(superclass)) {
                Py.writeWarning("org/jpp/compiler", "discarding redundant interface: " + iface.getName());
                continue;
            }
