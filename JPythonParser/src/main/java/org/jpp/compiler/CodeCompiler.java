...
import org.jpp.heart.AsyncContextGuard;
import org.jpp.heart.AsyncContextManager;
import org.jpp.heart.AsyncIterator;
import org.jpp.heart.CompareOp;
import org.jpp.heart.CompilerFlags;
import org.jpp.heart.ContextGuard;
import org.jpp.heart.ContextManager;
import org.jpp.heart.PyCoroutine;
...
import org.jpp.heart.PyFunction;
import org.jpp.heart.PyList;
import org.jpp.heart.PyObject;
import org.jpp.heart.PySet;
import org.jpp.heart.PySlice;
import org.jpp.heart.PyTuple;
import org.jpp.heart.PyUnicode;
import org.jpp.heart.ThreadState;

import static org.jpp.util.CodegenUtils.*;
...
public class CodeCompiler extends Visitor implements Opcodes, ClassConstants {
    ...
    final static Method contextGuard_getManager =
            Method.getMethod("org.jpp.heart.ContextManager getManager (org.jpp.heart.PyObject)");
    final static Method __enter__ =
            Method.getMethod("org.jpp.heart.PyObject __enter__ (org.jpp.heart.ThreadState)");
    final static Method __exit__ =
            Method.getMethod("boolean __exit__ (org.jpp.heart.ThreadState,org.jpp.heart.PyException)");
    /*
    ...
    @Override
    public Object visitModule(org.jpp.astnodes.ast.Module suite) throws Exception {
            ...
            case Store:
                ...
                if (syminf != null && (syminf.flags & ScopeInfo.GLOBAL) != 0) {
                    ...
                    if (!fast_locals) {
                        ...
                        if (syminf == null) {
                            throw new ParseException("internal org.jpp.compiler error", node);
                        }
                        code.iconst(syminf.locals_index);
                        code.aload(temporary);
                        code.invokevirtual(p(PyFrame.class), "setlocal",
