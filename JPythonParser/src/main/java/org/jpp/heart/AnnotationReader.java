...
public class AnnotationReader extends ClassVisitor {
    ...
    public AnnotationVisitor visitAnnotation(String desc, boolean visible) {
        nextVisitIsVersion = desc.equals("Lorg/python/org.jpp.compiler/APIVersion;");
        nextVisitIsMTime = desc.equals("Lorg/python/org.jpp.compiler/MTime;");
        nextVisitIsFilename = desc.equals("Lorg/python/org.jpp.compiler/Filename;");
