 ...
 * items in the right order, and creating and filling in org.jpp.modules.
 */
public abstract class importer extends PyObject {
    ...
    protected final PyObject importer_load_module(String fullname) {
        ...
        // the module *must* be in sys.org.jpp.modules before the loader executes the module code; the
