...
// support for a org.jpp.compiler factory that user code can choose in place of the
// normal org.jpp.compiler.
...
public class CompilerFlags implements Serializable {
    // These flags don't mean anything to the code, only to the org.jpp.compiler
...
//            | CodeFlag.CO_FUTURE_UNICODE_LITERALS.flag;
    ...
    // this will not strictly be an OR once we have other options, like a org.jpp.compiler factory
