 ...
 * can be attached to arbitrary {@link org.jpp.heart.PyObject}s.
 ...
 * to attach
 * {@link org.jpp.modules._weakref.GlobalRef}-objects in the
 * {@link org.jpp.modules._weakref.WeakrefModule}.
 * </p>
 * <p>
 ...
 * {@link org.jpp.heart.finalization.FinalizeTrigger}s and
 * {@code javaProxy} are included in the list; {@code javaProxy} always
 * on top so there is no speed-regression,
 * {@link org.jpp.heart.finalization.FinalizeTrigger} on bottom,
...
public abstract class JyAttribute implements Serializable {
    ...
    */
     ...
     * weakrefs (i.e. {@link org.jpp.modules._weakref.AbstractReference})
    ...
    /**
     * Allows the id of a {@link org.jpp.heart.PyObject} to persist
    ...
    /**
     * Checks whether the given {@link org.jpp.heart.PyObject}
