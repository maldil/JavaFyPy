...
public class JavaImportHelper {
     ...
     * sys.org.jpp.modules already contains a Py.None entry for the corresponding java package.
     * 
     ...
     * <p>
     * All parent packages appear as single entries like python org.jpp.modules, e.g. <code>java</code>,
    ...
    /**
     * Add a java package to sys.org.jpp.modules, if not already done
     * 
    ...
    private static boolean addPackage(String packageName, boolean packageAdded) {
        ...
        // a previously failed import could have created a Py.None entry in sys.org.jpp.modules
