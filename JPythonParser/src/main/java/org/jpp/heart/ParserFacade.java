...
import org.jpp.heart.io.TextIOInputStream;
...
/**
 * Facade for the classes in the org.jpp.astnodes package.
 */
...
//                reader = null;
    ...
    private static ExpectedEncodingBufferedReader prepBufReader(InputStream input,
        ...
        if (universalNewlines) {
            ...
            org.jpp.heart.io.BufferedReader bufferedIO =
                    new org.jpp.heart.io.BufferedReader(rawIO, 0);
