...
public class PyDictionary extends PyObject implements ConcurrentMap, Traverseproc {
    ...
    /*
     * The following methods implement the java.org.jpp.util.Map interface which allows PyDictionary to be
     * passed to java methods that take java.org.jpp.util.Map as a parameter. Basically, the Map methods are
...
/**
 * Wrapper for a Entry object returned from the java.org.jpp.util.Set object which in turn is returned by
 * the entrySet method of java.org.jpp.util.Map. This is needed to correctly convert from PyObjects to java
...
/**
 * MapEntry Object for java MapEntry objects passed to the java.org.jpp.util.Set interface which is returned
...
/**
 * Wrapper collection class for the keySet and values methods of java.org.jpp.util.Map
 */
...
/**
 * PyMapSet serves as a wrapper around Set Objects returned by the java.org.jpp.util.Map interface of
 * PyDictionary. entrySet, values and keySet methods return this type for the java.org.jpp.util.Map
