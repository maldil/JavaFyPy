...
class EmitVisitor(asdl.VisitorBase):
    ...
    def open(self, package, name, refersToPythonTree=1, useDataOutput=0):
        ...
        print('package org.jpp.astnodes.%s;' % package, file=self.file)
        if refersToPythonTree:
            print('import org.org.antlr.runtime.CommonToken;', file=self.file)
            print('import org.org.antlr.runtime.Token;', file=self.file)
            print('import org.jpp.astnodes.AST;', file=self.file)
            print('import org.jpp.astnodes.PythonTree;', file=self.file)
            print('import org.jpp.astnodes.adapter.AstAdapters;', file=self.file)
            print('import org.jpp.astnodes.base.excepthandler;',file=self.file)
            print('import org.jpp.astnodes.base.expr;', file=self.file)
            print('import org.jpp.astnodes.base.mod;', file=self.file)
            print('import org.jpp.astnodes.base.slice;',file=self.file)
            print('import org.jpp.astnodes.base.stmt;', file=self.file)
            print('import org.jpp.heart.ArgParser;', file=self.file)
            print('import org.jpp.heart.AstList;', file=self.file)
            print('import org.jpp.heart.Py;', file=self.file)
            print('import org.jpp.heart.PyObject;', file=self.file)
            print('import org.jpp.heart.PyUnicode;', file=self.file)
            print('import org.jpp.heart.PyStringMap;', file=self.file)
            print('import org.jpp.heart.PyType;',file=self.file)
            print('import org.jpp.heart.Visitproc;', file=self.file)
            print('import org.jpp.exposers.ExposedGet;', file=self.file)
            print('import org.jpp.exposers.ExposedMethod;', file=self.file)
            print('import org.jpp.exposers.ExposedNew;', file=self.file)
            print('import org.jpp.exposers.ExposedSet;', file=self.file)
            print('import org.jpp.exposers.ExposedType;',file=self.file)

        if useDataOutput:
            print('import java.io.DataOutputStream;',file=self.file)
            print('import java.io.IOException;', file=self.file)
            print('import java.org.jpp.util.ArrayList;', file=self.file)
...
class JavaVisitor(EmitVisitor):
    ...
    def simple_sum(self, sum, name, depth):
        ...
        self.emit('import org.jpp.astnodes.AST;', depth)
        self.emit('', 0)
    ...
    def simple_sum_wrappers(self, sum, name, depth):
        for i in range(len(sum.types)):
            ...
            self.emit('import org.jpp.astnodes.AST;', depth)
            self.emit('import org.jpp.astnodes.base.%s;' % name, depth)
            self.emit('import org.jpp.astnodes.PythonTree;', depth)
            self.emit('import org.jpp.heart.Py;', depth)
            self.emit('import org.jpp.heart.PyObject;', depth)
            self.emit('import org.jpp.heart.PyUnicode;', depth)
            self.emit('import org.jpp.heart.PyType;', depth)
            self.emit('import org.jpp.exposers.ExposedGet;', depth)
            self.emit('import org.jpp.exposers.ExposedMethod;', depth)
            self.emit('import org.jpp.exposers.ExposedNew;', depth)
            self.emit('import org.jpp.exposers.ExposedSet;', depth)
            self.emit('import org.jpp.exposers.ExposedType;', depth)
            self.emit('', 0)
    ...
    def javaType(self, field, check_seq=True):
        ...
        if check_seq and field.seq:
            return "java.org.jpp.util.List<%s>" % jtype
        return jtype
...
indexer_support = {
    ...
    public AsyncFunctionDef(Token token, Name name, arguments args, java.org.jpp.util.List<stmt> body, expr returnNode) {
        super(token);
    ...
    public void setDecorator_list(java.org.jpp.util.List<expr> decorator_list) {
...
""",
    ...
    public ClassDef(Token token, Name name, java.org.jpp.util.List<expr> bases,
                    java.org.jpp.util.List<keyword> keywords, java.org.jpp.util.List<stmt> body) {
        super(token);
        this.name = name.getText();
        this.nameNode = name;
        this.bases = bases;
...
""",
    ...
    public FunctionDef(Token token, Name name, arguments args, java.org.jpp.util.List<stmt> body, expr returnNode) {
        super(token);
        this.name = name.getText();
        this.nameNode = name;
        this.args = args;
...
""",
    ...
    private java.org.jpp.util.List<Name> nameNodes;
    public java.org.jpp.util.List<Name> getInternalNameNodes() {
        return nameNodes;
    }
    public Global(Token token, java.org.jpp.util.List<String> names, java.org.jpp.util.List<Name> nameNodes) {
        super(token);
        this.names = names;
...
""",
    ...
    public Nonlocal(Token token, java.org.jpp.util.List<String> names, java.org.jpp.util.List<Name> nameNodes) {
        super(token);
        this.names = names;
        this.nameNodes = nameNodes;
    }
...
""",
    ...
    private java.org.jpp.util.List<Name> moduleNames;
    public java.org.jpp.util.List<Name> getInternalModuleNames() {
        return moduleNames;
    }
    public ImportFrom(Token token,
                      String module, java.org.jpp.util.List<Name> moduleNames,
                      java.org.jpp.util.List<alias> names, Integer level) {
        super(token);
        this.module = module;
        this.names = names;
        if (names == null) {
...
""",
    ...
    public alias(Name name, Name asname) {
        this(java.org.jpp.util.Arrays.asList(new Name[]{name}), asname);
    }
    // [import] ...foo.bar.baz [as asname]
    public alias(java.org.jpp.util.List<Name> nameNodes, Name asname) {
        this.nameNodes = nameNodes;
...
if __name__ == "__main__":
    ...
    OUT_DIR = '../../src/main/java/org.jpp.astnodes/'
    try:
