...
public class PySetComprehension extends Expression{
    ...
    public static final ChildListPropertyDescriptor COMPARATOR= new ChildListPropertyDescriptor(PySetComprehension.class, "comparator", PyComparator.class, CYCLE_RISK);
