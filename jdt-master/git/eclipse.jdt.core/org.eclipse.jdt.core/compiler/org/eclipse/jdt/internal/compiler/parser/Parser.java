...
// This method is part of an automatic generation : do NOT edit-modify
    protected void consumeRule(int act) {
        switch (act) {
            ...
            case 103:
                if (DEBUG) {
                    System.out.println("InternalCompilationUnit ::= ModuleDeclaration");
                }  //$NON-NLS-1$
                consumeInternalCompilationUnitWithModuleDeclaration();
                break;
            ...
            case 104:
                if (DEBUG) {
                    System.out.println("ModuleDeclaration ::= ModuleHeader ModuleBody");
                }  //$NON-NLS-1$
            ...
            case 105:
                if (DEBUG) {
                    System.out.println("ModuleHeader ::= Modifiersopt ModuleModifieropt module");
                }  //$NON-NLS-1$
                consumeModuleHeader();
                break;
            ...
            case 107:
                if (DEBUG) {
                    System.out.println("ModuleModifieropt ::= ModuleModifier");
                }  //$NON-NLS-1$
            ...
            case 110:
                if (DEBUG) {
                    System.out.println("ModuleStatementsOpt ::=");
                }  //$NON-NLS-1$
            ...
            case 113:
                if (DEBUG) {
                    System.out.println("ModuleStatements ::= ModuleStatements ModuleStatement");
                }  //$NON-NLS-1$
            ...
            case 119:
                if (DEBUG) {
                    System.out.println("RequiresStatement ::= SingleRequiresModuleName SEMICOLON");
                }  //$NON-NLS-1$
            ...
            case 120:
                if (DEBUG) {
                    System.out.println("SingleRequiresModuleName ::= requires...");
                }  //$NON-NLS-1$
            ...
            case 121:
                if (DEBUG) {
                    System.out.println("RequiresModifiersopt ::= RequiresModifiers");
                }  //$NON-NLS-1$
                consumeModifiers();
                break;
            ...
            case 122:
                if (DEBUG) {
                    System.out.println("RequiresModifiersopt ::=");
                }  //$NON-NLS-1$
            ...
            case 124:
                if (DEBUG) {
                    System.out.println("RequiresModifiers ::= RequiresModifiers RequiresModifier");
                }  //$NON-NLS-1$
                consumeModifiers2();
                break;
            ...
            case 127:
                if (DEBUG) {
                    System.out.println("ExportsStatement ::= ExportsHeader TargetModuleListopt");
                }  //$NON-NLS-1$
            ...
            case 128:
                if (DEBUG) {
                    System.out.println("ExportsHeader ::= exports SinglePkgName");
                }  //$NON-NLS-1$
            ...
            case 130:
                if (DEBUG) {
                    System.out.println("TargetModuleListopt ::= to TargetModuleNameList");
                }  //$NON-NLS-1$
            ...
            case 131:
                if (DEBUG) {
                    System.out.println("TargetModuleName ::= UnannotatableName");
                }  //$NON-NLS-1$
            ...
            case 133:
                if (DEBUG) {
                    System.out.println("TargetModuleNameList ::= TargetModuleNameList COMMA...");
                }  //$NON-NLS-1$
            ...
            case 134:
                if (DEBUG) {
                    System.out.println("SinglePkgName ::= UnannotatableName");
                }  //$NON-NLS-1$
            ...
            case 135:
                if (DEBUG) {
                    System.out.println("OpensStatement ::= OpensHeader TargetModuleListopt...");
                }  //$NON-NLS-1$
            ...
            case 136:
                if (DEBUG) {
                    System.out.println("OpensHeader ::= opens SinglePkgName");
                }  //$NON-NLS-1$
                consumeOpensHeader();
                break;
            ...
            case 137:
                if (DEBUG) {
                    System.out.println("UsesStatement ::= UsesHeader SEMICOLON");
                }  //$NON-NLS-1$
            ...
            case 138:
                if (DEBUG) {
                    System.out.println("UsesHeader ::= uses Name");
                }  //$NON-NLS-1$
                consumeUsesHeader();
                break;
            ...
            case 139:
                if (DEBUG) {
                    System.out.println("ProvidesStatement ::= ProvidesInterface WithClause...");
                }  //$NON-NLS-1$
            ...
            case 140:
                if (DEBUG) {
                    System.out.println("ProvidesInterface ::= provides Name");
                }  //$NON-NLS-1$
            ...
            case 141:
                if (DEBUG) {
                    System.out.println("ServiceImplName ::= Name");
                }  //$NON-NLS-1$
            ...
            case 143:
                if (DEBUG) {
                    System.out.println("ServiceImplNameList ::= ServiceImplNameList COMMA...");
                }  //$NON-NLS-1$
            ...
            case 144:
                if (DEBUG) {
                    System.out.println("WithClause ::= with ServiceImplNameList");
                }  //$NON-NLS-1$
                consumeWithClause();
                break;
            ...
            case 324:
                if (DEBUG) {
                    System.out.println("RecordDeclaration ::= RecordHeaderPart RecordBody");
                }  //$NON-NLS-1$
            ...
            case 325:
                if (DEBUG) {
                    System.out.println("RecordHeaderPart ::= RecordHeaderName RecordHeader...");
                }  //$NON-NLS-1$
            ...
            case 326:
                if (DEBUG) {
                    System.out.println("RecordHeaderName ::= RecordHeaderName1 TypeParameters");
                }  //$NON-NLS-1$
            ...
            case 328:
                if (DEBUG) {
                    System.out.println("RecordHeaderName1 ::= Modifiersopt...");
                }  //$NON-NLS-1$
            ...
            case 329:
                if (DEBUG) {
                    System.out.println("RecordComponentHeaderRightParen ::= RPAREN");
                }  //$NON-NLS-1$
            ...
            case 330:
                if (DEBUG) {
                    System.out.println("RecordHeader ::= LPAREN RecordComponentsopt...");
                }  //$NON-NLS-1$
                consumeRecordHeader();
                break;
            ...
            case 331:
                if (DEBUG) {
                    System.out.println("RecordComponentsopt ::=");
                }  //$NON-NLS-1$
            ...
            case 334:
                if (DEBUG) {
                    System.out.println("RecordComponents ::= RecordComponents COMMA...");
                }  //$NON-NLS-1$
            ...
            case 336:
                if (DEBUG) {
                    System.out.println("RecordComponent ::= Modifiersopt Type...");
                }  //$NON-NLS-1$
            ...
            case 337:
                if (DEBUG) {
                    System.out.println("VariableArityRecordComponent ::= Modifiersopt Type...");
                }  //$NON-NLS-1$
            ...
            case 339:
                if (DEBUG) {
                    System.out.println("RecordBody ::= LBRACE RecordBodyDeclarationopt RBRACE");
                }  //$NON-NLS-1$
                consumeRecordBody();
                break;
            ...
            case 340:
                if (DEBUG) {
                    System.out.println("RecordBodyDeclarationopt ::=");
                }  //$NON-NLS-1$
            ...
            case 343:
                if (DEBUG) {
                    System.out.println("RecordBodyDeclarations ::= RecordBodyDeclarations...");
                }  //$NON-NLS-1$
            ...
            case 344:
                if (DEBUG) {
                    System.out.println("RecordBodyDeclaration ::= ClassBodyDeclaration");
                }  //$NON-NLS-1$
            ...
            case 345:
                if (DEBUG) {
                    System.out.println("RecordBodyDeclaration ::= CompactConstructorDeclaration");
                }  //$NON-NLS-1$
                consumeRecordBodyDeclaration();
                break;
            ...
            case 346:
                if (DEBUG) {
                    System.out.println("CompactConstructorDeclaration ::=...");
                }  //$NON-NLS-1$
            ...
            case 347:
                if (DEBUG) {
                    System.out.println("CompactConstructorHeader ::=...");
                }  //$NON-NLS-1$
            ...
            case 348:
                if (DEBUG) {
                    System.out.println("CompactConstructorHeaderName ::= Modifiersopt Identifier");
                }  //$NON-NLS-1$
            ...
            case 349:
                if (DEBUG) {
                    System.out.println("CompactConstructorHeaderName ::= Modifiersopt...");
                }  //$NON-NLS-1$
            ...
            case 355:
                if (DEBUG) {
                    System.out.println("TypeTestPattern ::= Type Identifier");
                }  //$NON-NLS-1$
            ...
            case 439:
                if (DEBUG) {
                    System.out.println("SwitchLabel ::= SwitchLabelCaseLhs COLON");
                }  //$NON-NLS-1$
                consumeCaseLabel();
                break;
            ...
            case 443:
                if (DEBUG) {
                    System.out.println("SwitchExpression ::= switch LPAREN Expression RPAREN...");
                }  //$NON-NLS-1$
            ...
            case 446:
                if (DEBUG) {
                    System.out.println("SwitchLabeledRule ::= SwitchLabeledThrowStatement");
                }  //$NON-NLS-1$
            ...
            case 447:
                if (DEBUG) {
                    System.out.println("SwitchLabeledExpression ::= SwitchLabelExpr Expression");
                }  //$NON-NLS-1$
            ...
            case 448:
                if (DEBUG) {
                    System.out.println("SwitchLabeledBlock ::= SwitchLabelExpr Block");
                }  //$NON-NLS-1$
            ...
            case 449:
                if (DEBUG) {
                    System.out.println("SwitchLabeledThrowStatement ::= SwitchLabelExpr...");
                }  //$NON-NLS-1$
            ...
            case 450:
                if (DEBUG) {
                    System.out.println("SwitchLabelExpr ::= default ARROW");
                }  //$NON-NLS-1$
            ...
            case 451:
                if (DEBUG) {
                    System.out.println("SwitchLabelExpr ::= SwitchLabelCaseLhs BeginCaseExpr...");
                }  //$NON-NLS-1$
            ...
            case 452:
                if (DEBUG) {
                    System.out.println("SwitchLabelCaseLhs ::= case ConstantExpressions");
                }  //$NON-NLS-1$
            ...
            case 453:
                if (DEBUG) {
                    System.out.println("YieldStatement ::= RestrictedIdentifierYield Expression");
                }  //$NON-NLS-1$
            ...
            case 459:
                if (DEBUG) {
                    System.out.println("WithstmtStatement ::= withstmt LPAREN Expression RPAREN");
                }  //$NON-NLS-1$
            ...
            case 460:
                if (DEBUG) {
                    System.out.println("WithstmtStatementNoShortIf ::= withstmt LPAREN...");
                }  //$NON-NLS-1$
                consumeStatementWithstmt();
                break;
            ...
            case 474:
                if (DEBUG) {
                    System.out.println("ThrowExpression ::= throw Expression");
                }  //$NON-NLS-1$
            ...
            case 490:
                if (DEBUG) {
                    System.out.println("Resource ::= FieldAccess");
                }  //$NON-NLS-1$
            ...
            case 643:
                if (DEBUG) {
                    System.out.println("InExpression ::= InExpression in EqualityExpression");
                }  //$NON-NLS-1$
                consumeInExpression();
                break;
            ...
            case 645:
                if (DEBUG) {
                    System.out.println("AndExpression ::= AndExpression AND InExpression");
                }  //$NON-NLS-1$
            ...
            case 679:
                if (DEBUG) {
                    System.out.println("ConstantExpressions ::= ConstantExpressions COMMA...");
                }  //$NON-NLS-1$
            ...
            case 702:
                if (DEBUG) {
                    System.out.println("ClassHeaderPermittedSubclasses ::=...");
                }  //$NON-NLS-1$
            ...
            case 705:
                if (DEBUG) {
                    System.out.println("InterfaceHeaderPermittedSubClassesAndSubInterfaces ::=");
                }  //$NON-NLS-1$
            ...
            case 742:
                if (DEBUG) {
                    System.out.println("EnhancedForStatementHeaderInit ::= for LPAREN...");
                }  //$NON-NLS-1$
            ...
            case 855:
                if (DEBUG) {
                    System.out.println("InExpression_NotName ::= InExpression_NotName in...");
                }  //$NON-NLS-1$
                consumeInExpression();
                break;
            ...
            case 856:
                if (DEBUG) {
                    System.out.println("InExpression_NotName ::= Name in EqualityExpression");
                }  //$NON-NLS-1$
            ...
            case 859:
                if (DEBUG) {
                    System.out.println("AndExpression_NotName ::= Name AND InExpression");
                }  //$NON-NLS-1$
