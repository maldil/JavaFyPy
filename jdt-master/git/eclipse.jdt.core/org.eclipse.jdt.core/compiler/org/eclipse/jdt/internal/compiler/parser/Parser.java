...
protected void consumeRule(int act) {
 ...
 consumeMethodDeclaration(false, false);
    ...
    case 353 : if (DEBUG) { System.out.println("InExpression ::= InExpression in Expression"); }  //$NON-NLS-1$
		    consumeInExpression();
			break;
    ...
    case 850 : if (DEBUG) { System.out.println("InExpression_NotName ::= Expression in Expression"); }  //$NON-NLS-1$
		    consumeInExpressionWithName();
			break;

    case 851 : if (DEBUG) { System.out.println("InExpression_NotName ::= InExpression_NotName in..."); }  //$NON-NLS-1$
		    consumeInExpression();
			break;
