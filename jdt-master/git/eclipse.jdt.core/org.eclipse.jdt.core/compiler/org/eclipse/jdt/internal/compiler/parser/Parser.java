...
protected void consumeRule(int act) {
 ...
 consumeMethodDeclaration(false, false);
    ...
    case 353 : if (DEBUG) { System.out.println("InExpression ::= InExpression in Name"); }  //$NON-NLS-1$
		    consumeInExpression();
			break;

    case 357 : if (DEBUG) { System.out.println("TypeTestPattern ::= Type Identifier"); }  //$NON-NLS-1$
    ...
    case 847 : if (DEBUG) { System.out.println("InExpression_NotName ::= Name in Name"); }  //$NON-NLS-1$
		    consumeInExpressionWithName();
			break;

    case 848 : if (DEBUG) { System.out.println("InExpression_NotName ::= InExpression_NotName in Name"); }  //$NON-NLS-1$
		    consumeInExpression();
			break;
