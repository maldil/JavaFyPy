...
//	annotationTypeDeclaration.typeParameters = null;
    ...
    protected void consumeArrayCreationExpressionWithUnionWithInitializer(){
        System.out.println("consumeArrayCreationExpressionWithUnionWithInitializer");
    }

    protected void consumeArrayCreationExpressionWithUnionWithoutInitializer(){
        System.out.println("consumeArrayCreationExpressionWithUnionWithoutInitializer");
    }
    ...
    protected void consumeGeneratorsWithName(){
        System.out.println("fired with name");
    }
...
//    protected void consumeGeneratorsWithoutIF(){
//        this.intPtr -= 1;
//        this.expressionPtr -= 2;
...
//        pyGenerators.updateIndices();
//        this.expressionStack[this.expressionPtr] = pyGenerators;
//
//
//    }
    protected void consumeDickComp(){
        Expression compareter = this.expressionStack[this.expressionPtr];
        PyDicComp pyGenerators =  new PyDicComp();

        while (compareter instanceof PyComparator){

            pyGenerators.setComparetor((PyComparator) compareter);
            compareter = this.expressionStack[--this.expressionPtr];
            this.intPtr --;
            this.expressionLengthPtr--;
        }
    ...
    protected void consumeDickCompWithIF(){
//        this.intPtr -= 2;//consume position of the question mark
//        this.expressionPtr -= 4;
//        this.expressionLengthPtr -= 3;
//        PyDicComp dicComp = new PyDicComp();
//        dicComp.setBinaryExpression( this.expressionStack[this.expressionPtr+4]);
//        dicComp.setIterator(this.expressionStack[this.expressionPtr+3]);
//        dicComp.setTypeValues(((TupleTypeExpression)this.expressionStack[this.expressionPtr+2]).getLocalDeclarations());
//        dicComp.setTarget2(this.expressionStack[this.expressionPtr+1]);
//        dicComp.setTarget1(this.expressionStack[this.expressionPtr]);
//        dicComp.updateIndices();
//        this.expressionStack[this.expressionPtr] = dicComp;
    }

    protected void consumeDickCompWithoutIF(){
//        PyDicComp dicComp = new PyDicComp();
//        this.intPtr -= 1;
//        this.expressionPtr -= 3;
//        this.expressionLengthPtr -= 2;
//        dicComp.setIterator(this.expressionStack[this.expressionPtr + 3]);
//        dicComp.setTypeValues(((TupleTypeExpression)this.expressionStack[this.expressionPtr + 2]).getLocalDeclarations());
//        dicComp.setTarget2(this.expressionStack[this.expressionPtr+1]);
...
//    protected void consumeGeneratorsWithoutIFWithName(){
//        this.intPtr -= 1;
...
//    }
    ...
    protected void consumeGeneratorHeaderWithoutIf(){
//        this.intPtr -= 1;//consume position of the question mark
        this.expressionPtr -= 1;
//        this.expressionLengthPtr -= 1;

        PyComparator pyGenerators =  new PyComparator();
        pyGenerators.setIterator(this.expressionStack[this.expressionPtr+1]);
        pyGenerators.setTypeValues(((TupleTypeExpression)this.expressionStack[this.expressionPtr]).getLocalDeclarations());
        pyGenerators.updateIndices();
        this.expressionStack[this.expressionPtr] = pyGenerators;
    }

    protected void consumeGeneratorHeader(){}

    protected void consumeGeneratorHeaderWithIf(){
        this.intPtr -= 1;//consume position of the question mark
        this.expressionPtr -= 2;
        this.expressionLengthPtr -= 1;
        ...
        PyComparator pyGenerators =  new PyComparator();
        pyGenerators.setBinaryExpression( this.expressionStack[this.expressionPtr+2]);
        pyGenerators.setIterator(this.expressionStack[this.expressionPtr+1]);
        pyGenerators.setTypeValues(((TupleTypeExpression)this.expressionStack[this.expressionPtr]).getLocalDeclarations());
        pyGenerators.updateIndices();
        this.expressionStack[this.expressionPtr] = pyGenerators;
    }
    protected void consumeGenerators(){

//        ConditionalExpression ::= Expression 'for' TupleExpression ':' ConditionalExpression 'if' ConditionalOrExpression

//        this.intPtr -= 1;//consume position of the question mark
//        this.expressionPtr -= 2;
//        this.expressionLengthPtr -= 2;
//
//        ArrayList<LocalDeclaration> localDeclarations = new ArrayList();
//
//        while(this.intPtr > 0) {
//            LocalDeclaration localDeclaration = this.getLocalDeclarations(false);
//            if (Arrays.equals(localDeclaration.name, "DummyTerminalNode".toCharArray())) {
//                break;
//            }
...
//
//        PyGenerators pyGenerators =  new PyGenerators();
//        pyGenerators.setBinaryExpression((BinaryExpression) this.expressionStack[this.expressionPtr+2]);
//        pyGenerators.setIterator(this.expressionStack[this.expressionPtr+1]);
//        pyGenerators.setTypeValues(localDeclarations);
//        pyGenerators.setTarget(this.expressionStack[this.expressionPtr]);
//        pyGenerators.updateIndices();
//        this.expressionStack[this.expressionPtr] = pyGenerators;
//        this.intPtr -= 1;

        Object compareter = this.expressionStack[this.expressionPtr];
        PyGenerators pyGenerators =  new PyGenerators();
        ...
        pyGenerators.setTarget((Expression) compareter);
        pyGenerators.updateIndices();
...
//        pyGenerators.updateIndices();
    ...
    protected void consumeTupleWithName(){
//        TupleExpression_NotName ::= Name 'pyjavatuple' InExpression
        ...
        this.expressionStack[this.expressionPtr] = new TupleExpression(expr1, expr2);
    }
...
//                            op);
    ...
    protected void consumeTuple(){
        this.expressionPtr--;
        this.expressionLengthPtr--;
        Expression expr1 = this.expressionStack[this.expressionPtr];
        Expression expr2 = this.expressionStack[this.expressionPtr + 1];
        this.expressionStack[this.expressionPtr] = new TupleExpression(expr1, expr2);
//        int length = this.patternLengthPtr >= 0 ? this.patternLengthStack[this.patternLengthPtr--] : 0;
//        Expression right;
//        if (length > 0) {
//            right = (Expression)this.patternStack[this.patternPtr--];
//            this.expressionStack[this.expressionPtr] = new TupleExpression(this.expressionStack[this.expressionPtr], right);
//        } else {
//            right = this.expressionStack[this.expressionPtr--];
//            Expression left = this.expressionStack[this.expressionPtr];
//            this.expressionStack[this.expressionPtr] = new TupleExpression(left, right);
//        }
...
//	pushOnAstStack(caseStatement);
	...
	*/
    ...
    protected void consumeEnhancedForStatementWithElse(){
        this.astLengthPtr--;
        this.astLengthPtr--;
        Statement elsestatement = (Statement) this.astStack[this.astPtr--];
        ...
        foreachStatement.elseaction = elsestatement;
        ...
        if (elsestatement instanceof EmptyStatement) elsestatement.bits |= ASTNode.IsUsefulEmptyStatement;
    ...
    protected void consumeGenEnhancedForStatementHeaderInit(){
        ArrayList<LocalDeclaration> localDeclarations = new ArrayList<LocalDeclaration>();
        while (this.intPtr>0){
            LocalDeclaration localDeclaration = getLocalDeclarations(false);
            if (Arrays.equals(localDeclaration.name, "DummyTerminalNode".toCharArray())){
                break;
            }
            localDeclarations.add(localDeclaration);
        ...
        this.expressionStack[++this.expressionPtr] = new TupleTypeExpression(localDeclarations);
    }

    protected void consumeEnhancedForStatementHeaderInit(boolean hasModifiers) {
        ArrayList<LocalDeclaration> localDeclarations = new ArrayList<LocalDeclaration>();
        ArrayList<LocalDeclaration> localDeclarationsextras = new ArrayList<LocalDeclaration>();
        while (this.intPtr>0){
            LocalDeclaration localDeclaration = getLocalDeclarations(hasModifiers);
            if (Arrays.equals(localDeclaration.name, "DummyTerminalNode".toCharArray())){
                break;
            }
            localDeclarations.add(localDeclaration);
        ...
        for (int i=(localDeclarations.size()-1);i>=0 ;i--){
            if (i!=(localDeclarations.size()-1)){
                localDeclarationsextras.add(localDeclarations.get(i));
            }
        }

        ForeachStatement iteratorForStatement =
                new ForeachStatement(
                        localDeclarations.get(localDeclarations.size()-1),
                        this.intStack[this.intPtr--],localDeclarationsextras);
        pushOnAstStack(iteratorForStatement);

        iteratorForStatement.sourceEnd = localDeclarations.get(0).declarationSourceEnd;
        this.forStartPosition = 0;
    }


    private LocalDeclaration getLocalDeclarations(boolean hasModifiers) {
        TypeReference type;
...
//	}
	...
	*/
    ...
    protected void consumeInExpressionWithName() {
        pushOnExpressionStack(getUnspecifiedReferenceOptimized());
        --this.expressionPtr;
        --this.expressionLengthPtr;
        Expression expr1 = this.expressionStack[this.expressionPtr + 1];
        Expression expr2 = this.expressionStack[this.expressionPtr];
        Expression exp;
        this.expressionStack[this.expressionPtr] =exp= new InExpression(expr1,expr2);
        if (exp.sourceEnd == 0) {
            //array on base type....
    ...
    protected void consumeNotInExpressionWithName() {
        pushOnExpressionStack(getUnspecifiedReferenceOptimized());
        --this.expressionPtr;
        --this.expressionLengthPtr;
        Expression expr1 = this.expressionStack[this.expressionPtr + 1];
        Expression expr2 = this.expressionStack[this.expressionPtr];
        Expression exp;
        this.expressionStack[this.expressionPtr] =exp= new NotInExpression(expr1,expr2);
        if (exp.sourceEnd == 0) {
            //array on base type....
            exp.sourceEnd = this.scanner.startPosition - 1;
        }
    ...
    protected void consumeNotInExpression() {
        int length = this.patternLengthPtr >= 0 ?
                this.patternLengthStack[this.patternLengthPtr--] : 0;
        Expression exp;
        if (length > 0) {
            Expression right = (Expression) this.patternStack[this.patternPtr--];
            this.expressionStack[this.expressionPtr] = exp =
                    new NotInExpression(
                            this.expressionStack[this.expressionPtr],
                            right);
        } else {
            Expression right = this.expressionStack[this.expressionPtr--];
            Expression left = this.expressionStack[this.expressionPtr];
            this.expressionStack[this.expressionPtr] = exp = new NotInExpression(left, right);
        }
        if (exp.sourceEnd == 0) {
            //array on base type....
            exp.sourceEnd = this.scanner.startPosition - 1;
    ...
    protected void consumeInExpression() {
        int length = this.patternLengthPtr >= 0 ?
                this.patternLengthStack[this.patternLengthPtr--] : 0;
        Expression exp;
        if (length > 0) {
            ...
            Expression right = this.expressionStack[this.expressionPtr--];
            Expression left = this.expressionStack[this.expressionPtr];
            this.expressionStack[this.expressionPtr] = exp = new InExpression(left, right);
        }
        if (exp.sourceEnd == 0) {
            //array on base type....
            exp.sourceEnd = this.scanner.startPosition - 1;
...
protected void consumeRule(int act) {
  switch ( act ) {
    ...
    case 229 : if (DEBUG) { System.out.println("ClassMemberDeclaration ::= SEMICOLON"); }  //$NON-NLS-1$
		    consumeEmptyTypeDeclaration();
			break;

    case 232 : if (DEBUG) { System.out.println("FieldDeclaration ::= Modifiersopt Type..."); }  //$NON-NLS-1$
		    consumeFieldDeclaration();
			break;

    case 234 : if (DEBUG) { System.out.println("VariableDeclarators ::= VariableDeclarators COMMA..."); }  //$NON-NLS-1$
		    consumeVariableDeclarators();
			break;

    case 237 : if (DEBUG) { System.out.println("EnterVariable ::="); }  //$NON-NLS-1$
		    consumeEnterVariable();
			break;

    case 238 : if (DEBUG) { System.out.println("ExitVariableWithInitialization ::="); }  //$NON-NLS-1$
		    consumeExitVariableWithInitialization();
			break;

    case 239 : if (DEBUG) { System.out.println("ExitVariableWithoutInitialization ::="); }  //$NON-NLS-1$
		    consumeExitVariableWithoutInitialization();
			break;

    case 240 : if (DEBUG) { System.out.println("ForceNoDiet ::="); }  //$NON-NLS-1$
		    consumeForceNoDiet();
			break;

    case 241 : if (DEBUG) { System.out.println("RestoreDiet ::="); }  //$NON-NLS-1$
		    consumeRestoreDiet();
			break;

    case 246 : if (DEBUG) { System.out.println("MethodDeclaration ::= MethodHeader MethodBody"); }  //$NON-NLS-1$
		    // set to true to consume a method with a body
 consumeMethodDeclaration(true, false);
			break;

    case 247 : if (DEBUG) { System.out.println("MethodDeclaration ::= DefaultMethodHeader MethodBody"); }  //$NON-NLS-1$
		    // set to true to consume a method with a body
 consumeMethodDeclaration(true, true);
			break;

    case 248 : if (DEBUG) { System.out.println("AbstractMethodDeclaration ::= MethodHeader SEMICOLON"); }  //$NON-NLS-1$
		    // set to false to consume a method without body
 consumeMethodDeclaration(false, false);
			break;

    case 249 : if (DEBUG) { System.out.println("MethodHeader ::= MethodHeaderName FormalParameterListopt"); }  //$NON-NLS-1$
		    consumeMethodHeader();
			break;

    case 250 : if (DEBUG) { System.out.println("DefaultMethodHeader ::= DefaultMethodHeaderName..."); }  //$NON-NLS-1$
		    consumeMethodHeader();
			break;

    case 251 : if (DEBUG) { System.out.println("MethodHeaderName ::= Modifiersopt TypeParameters Type..."); }  //$NON-NLS-1$
		    consumeMethodHeaderNameWithTypeParameters(false);
			break;

    case 252 : if (DEBUG) { System.out.println("MethodHeaderName ::= Modifiersopt Type Identifier LPAREN"); }  //$NON-NLS-1$
		    consumeMethodHeaderName(false);
			break;

    case 253 : if (DEBUG) { System.out.println("DefaultMethodHeaderName ::= ModifiersWithDefault..."); }  //$NON-NLS-1$
		    consumeMethodHeaderNameWithTypeParameters(false);
			break;

    case 254 : if (DEBUG) { System.out.println("DefaultMethodHeaderName ::= ModifiersWithDefault Type..."); }  //$NON-NLS-1$
		    consumeMethodHeaderName(false);
			break;

    case 255 : if (DEBUG) { System.out.println("ModifiersWithDefault ::= Modifiersopt default..."); }  //$NON-NLS-1$
		    consumePushCombineModifiers();
			break;

    case 256 : if (DEBUG) { System.out.println("MethodHeaderRightParen ::= RPAREN"); }  //$NON-NLS-1$
		    consumeMethodHeaderRightParen();
			break;

    case 257 : if (DEBUG) { System.out.println("MethodHeaderExtendedDims ::= Dimsopt"); }  //$NON-NLS-1$
		    consumeMethodHeaderExtendedDims();
			break;

    case 258 : if (DEBUG) { System.out.println("MethodHeaderThrowsClause ::= throws ClassTypeList"); }  //$NON-NLS-1$
		    consumeMethodHeaderThrowsClause();
			break;

    case 259 : if (DEBUG) { System.out.println("ConstructorHeader ::= ConstructorHeaderName..."); }  //$NON-NLS-1$
		    consumeConstructorHeader();
			break;

    case 260 : if (DEBUG) { System.out.println("ConstructorHeaderName ::= Modifiersopt TypeParameters..."); }  //$NON-NLS-1$
		    consumeConstructorHeaderNameWithTypeParameters();
			break;

    case 261 : if (DEBUG) { System.out.println("ConstructorHeaderName ::= Modifiersopt Identifier LPAREN"); }  //$NON-NLS-1$
		    consumeConstructorHeaderName();
			break;

    case 263 : if (DEBUG) { System.out.println("FormalParameterList ::= FormalParameterList COMMA..."); }  //$NON-NLS-1$
    ...
    case 266 : if (DEBUG) { System.out.println("FormalParameter ::= Modifiersopt Type AT308DOTDOTDOT..."); }  //$NON-NLS-1$
		    consumeFormalParameter(true);
			break;

    case 267 : if (DEBUG) { System.out.println("CatchFormalParameter ::= Modifiersopt CatchType..."); }  //$NON-NLS-1$
		    consumeCatchFormalParameter();
			break;

    case 268 : if (DEBUG) { System.out.println("CatchType ::= UnionType"); }  //$NON-NLS-1$
		    consumeCatchType();
			break;

    case 269 : if (DEBUG) { System.out.println("UnionType ::= Type"); }  //$NON-NLS-1$
		    consumeUnionTypeAsClassType();
			break;

    case 270 : if (DEBUG) { System.out.println("UnionType ::= UnionType OR Type"); }  //$NON-NLS-1$
		    consumeUnionType();
			break;

    case 272 : if (DEBUG) { System.out.println("ClassTypeList ::= ClassTypeList COMMA ClassTypeElt"); }  //$NON-NLS-1$
		    consumeClassTypeList();
			break;

    case 273 : if (DEBUG) { System.out.println("ClassTypeElt ::= ClassType"); }  //$NON-NLS-1$
		    consumeClassTypeElt();
			break;

    case 274 : if (DEBUG) { System.out.println("MethodBody ::= NestedMethod LBRACE BlockStatementsopt..."); }  //$NON-NLS-1$
		    consumeMethodBody();
			break;

    case 275 : if (DEBUG) { System.out.println("NestedMethod ::="); }  //$NON-NLS-1$
		    consumeNestedMethod();
			break;

    case 276 : if (DEBUG) { System.out.println("StaticInitializer ::= StaticOnly Block"); }  //$NON-NLS-1$
		    consumeStaticInitializer();
			break;

    case 277 : if (DEBUG) { System.out.println("StaticOnly ::= static"); }  //$NON-NLS-1$
		    consumeStaticOnly();
			break;

    case 278 : if (DEBUG) { System.out.println("ConstructorDeclaration ::= ConstructorHeader MethodBody"); }  //$NON-NLS-1$
		    consumeConstructorDeclaration() ;
			break;

    case 279 : if (DEBUG) { System.out.println("ConstructorDeclaration ::= ConstructorHeader SEMICOLON"); }  //$NON-NLS-1$
		    consumeInvalidConstructorDeclaration() ;
			break;

    case 280 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= this LPAREN..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocation(0, THIS_CALL);
			break;

    case 281 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= OnlyTypeArguments this"); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocationWithTypeArguments(0,THIS_CALL);
			break;

    case 282 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= super LPAREN..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocation(0,SUPER_CALL);
			break;

    case 283 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= OnlyTypeArguments..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocationWithTypeArguments(0,SUPER_CALL);
			break;

    case 284 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Primary DOT super..."); }  //$NON-NLS-1$
    ...
    case 286 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Name DOT super LPAREN"); }  //$NON-NLS-1$
    ...
    case 288 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Primary DOT this..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocation(1, THIS_CALL);
			break;

    case 289 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Primary DOT..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocationWithTypeArguments(1, THIS_CALL);
			break;

    case 290 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Name DOT this LPAREN"); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocation(2, THIS_CALL);
			break;

    case 291 : if (DEBUG) { System.out.println("ExplicitConstructorInvocation ::= Name DOT..."); }  //$NON-NLS-1$
		    consumeExplicitConstructorInvocationWithTypeArguments(2, THIS_CALL);
			break;

    case 292 : if (DEBUG) { System.out.println("InterfaceDeclaration ::= InterfaceHeader InterfaceBody"); }  //$NON-NLS-1$
		    consumeInterfaceDeclaration();
			break;

    case 293 : if (DEBUG) { System.out.println("InterfaceHeader ::= InterfaceHeaderName..."); }  //$NON-NLS-1$
		    consumeInterfaceHeader();
			break;

    case 294 : if (DEBUG) { System.out.println("InterfaceHeaderName ::= InterfaceHeaderName1..."); }  //$NON-NLS-1$
		    consumeTypeHeaderNameWithTypeParameters();
			break;

    case 296 : if (DEBUG) { System.out.println("InterfaceHeaderName1 ::= Modifiersopt interface..."); }  //$NON-NLS-1$
		    consumeInterfaceHeaderName1();
			break;

    case 297 : if (DEBUG) { System.out.println("InterfaceHeaderExtends ::= extends InterfaceTypeList"); }  //$NON-NLS-1$
		    consumeInterfaceHeaderExtends();
			break;

    case 300 : if (DEBUG) { System.out.println("InterfaceMemberDeclarations ::=..."); }  //$NON-NLS-1$
		    consumeInterfaceMemberDeclarations();
			break;

    case 301 : if (DEBUG) { System.out.println("InterfaceMemberDeclaration ::= SEMICOLON"); }  //$NON-NLS-1$
		    consumeEmptyTypeDeclaration();
			break;
    ...
    case 304 : if (DEBUG) { System.out.println("InterfaceMemberDeclaration ::= MethodHeader MethodBody"); }  //$NON-NLS-1$
		    consumeInterfaceMethodDeclaration(false);
			break;
    ...
    case 318 : if (DEBUG) { System.out.println("RecordDeclaration ::= RecordHeaderPart RecordBody"); }  //$NON-NLS-1$
		    consumeRecordDeclaration();
			break;

    case 319 : if (DEBUG) { System.out.println("RecordHeaderPart ::= RecordHeaderName RecordHeader..."); }  //$NON-NLS-1$
		    consumeRecordHeaderPart();
			break;

    case 320 : if (DEBUG) { System.out.println("RecordHeaderName ::= RecordHeaderName1 TypeParameters"); }  //$NON-NLS-1$
		    consumeRecordHeaderNameWithTypeParameters();
			break;

    case 322 : if (DEBUG) { System.out.println("RecordHeaderName1 ::= Modifiersopt..."); }  //$NON-NLS-1$
		    consumeRecordHeaderName1();
			break;

    case 323 : if (DEBUG) { System.out.println("RecordComponentHeaderRightParen ::= RPAREN"); }  //$NON-NLS-1$
		    consumeRecordComponentHeaderRightParen();
			break;

    case 324 : if (DEBUG) { System.out.println("RecordHeader ::= LPAREN RecordComponentsopt..."); }  //$NON-NLS-1$
		    consumeRecordHeader();
			break;

    case 325 : if (DEBUG) { System.out.println("RecordComponentsopt ::="); }  //$NON-NLS-1$
    ...
    case 330 : if (DEBUG) { System.out.println("RecordComponent ::= Modifiersopt Type..."); }  //$NON-NLS-1$
		    consumeRecordComponent(false);
			break;

    case 331 : if (DEBUG) { System.out.println("VariableArityRecordComponent ::= Modifiersopt Type..."); }  //$NON-NLS-1$
    ...
    case 333 : if (DEBUG) { System.out.println("RecordBody ::= LBRACE RecordBodyDeclarationopt RBRACE"); }  //$NON-NLS-1$
		    consumeRecordBody();
			break;

    case 334 : if (DEBUG) { System.out.println("RecordBodyDeclarationopt ::="); }  //$NON-NLS-1$
		    consumeEmptyRecordBodyDeclaration();
			break;

    case 337 : if (DEBUG) { System.out.println("RecordBodyDeclarations ::= RecordBodyDeclarations..."); }  //$NON-NLS-1$
		    consumeRecordBodyDeclarations();
			break;

    case 338 : if (DEBUG) { System.out.println("RecordBodyDeclaration ::= ClassBodyDeclaration"); }  //$NON-NLS-1$
		    consumeRecordBodyDeclaration();
			break;

    case 339 : if (DEBUG) { System.out.println("RecordBodyDeclaration ::= CompactConstructorDeclaration"); }  //$NON-NLS-1$
		    consumeRecordBodyDeclaration();
			break;

    case 340 : if (DEBUG) { System.out.println("CompactConstructorDeclaration ::=..."); }  //$NON-NLS-1$
		    consumeCompactConstructorDeclaration();
			break;

    case 341 : if (DEBUG) { System.out.println("CompactConstructorHeader ::=..."); }  //$NON-NLS-1$
		    consumeCompactConstructorHeader();
			break;

    case 342 : if (DEBUG) { System.out.println("CompactConstructorHeaderName ::= Modifiersopt Identifier"); }  //$NON-NLS-1$
		    consumeCompactConstructorHeaderName();
			break;

    case 343 : if (DEBUG) { System.out.println("CompactConstructorHeaderName ::= Modifiersopt..."); }  //$NON-NLS-1$
		    consumeCompactConstructorHeaderNameWithTypeParameters();
			break;

    case 345 : if (DEBUG) { System.out.println("InstanceofExpression ::= InstanceofExpression instanceof"); }  //$NON-NLS-1$
		    consumeInstanceOfExpression();
			break;

    case 349 : if (DEBUG) { System.out.println("TypeTestPattern ::= Type Identifier"); }  //$NON-NLS-1$
		    consumeTypeTestPattern();
			break;

    case 351 : if (DEBUG) { System.out.println("PushLeftBrace ::="); }  //$NON-NLS-1$
		    consumePushLeftBrace();
			break;

    case 352 : if (DEBUG) { System.out.println("ArrayInitializer ::= LBRACE PushLeftBrace ,opt RBRACE"); }  //$NON-NLS-1$
    ...
    case 356 : if (DEBUG) { System.out.println("VariableInitializers ::= VariableInitializers COMMA..."); }  //$NON-NLS-1$
		    consumeVariableInitializers();
			break;

    case 357 : if (DEBUG) { System.out.println("Block ::= OpenBlock LBRACE BlockStatementsopt RBRACE"); }  //$NON-NLS-1$
		    consumeBlock();
			break;

    case 358 : if (DEBUG) { System.out.println("OpenBlock ::="); }  //$NON-NLS-1$
		    consumeOpenBlock() ;
			break;

    case 359 : if (DEBUG) { System.out.println("BlockStatements ::= BlockStatement"); }  //$NON-NLS-1$
		    consumeBlockStatement() ;
			break;

    case 360 : if (DEBUG) { System.out.println("BlockStatements ::= BlockStatements BlockStatement"); }  //$NON-NLS-1$
		    consumeBlockStatements() ;
			break;

    case 368 : if (DEBUG) { System.out.println("BlockStatement ::= InterfaceDeclaration"); }  //$NON-NLS-1$
		    consumeInvalidInterfaceDeclaration();
			break;

    case 369 : if (DEBUG) { System.out.println("BlockStatement ::= AnnotationTypeDeclaration"); }  //$NON-NLS-1$
		    consumeInvalidAnnotationTypeDeclaration();
			break;

    case 370 : if (DEBUG) { System.out.println("BlockStatement ::= EnumDeclaration"); }  //$NON-NLS-1$
		    consumeInvalidEnumDeclaration();
			break;

    case 371 : if (DEBUG) { System.out.println("LocalVariableDeclarationStatement ::=..."); }  //$NON-NLS-1$
		    consumeLocalVariableDeclarationStatement();
			break;

    case 372 : if (DEBUG) { System.out.println("LocalVariableDeclaration ::= Type PushModifiers..."); }  //$NON-NLS-1$
		    consumeLocalVariableDeclaration();
			break;

    case 373 : if (DEBUG) { System.out.println("LocalVariableDeclaration ::= Modifiers Type..."); }  //$NON-NLS-1$
		    consumeLocalVariableDeclaration();
			break;

    case 374 : if (DEBUG) { System.out.println("PushModifiers ::="); }  //$NON-NLS-1$
		    consumePushModifiers();
			break;

    case 375 : if (DEBUG) { System.out.println("PushModifiersForHeader ::="); }  //$NON-NLS-1$
		    consumePushModifiersForHeader();
			break;

    case 376 : if (DEBUG) { System.out.println("PushRealModifiers ::="); }  //$NON-NLS-1$
    ...
    case 457 : if (DEBUG) { System.out.println("WithstmtStatement ::= withstmt LPAREN Expression RPAREN"); }  //$NON-NLS-1$
		    consumeStatementWithstmt() ;
			break;

    case 458 : if (DEBUG) { System.out.println("WithstmtStatementNoShortIf ::= withstmt LPAREN..."); }  //$NON-NLS-1$
		    consumeStatementWithstmt() ;
			break;
    ...
    case 464 : if (DEBUG) { System.out.println("AssertStatement ::= assert Expression SEMICOLON"); }  //$NON-NLS-1$
		    consumeSimpleAssertStatement() ;
			break;

    case 465 : if (DEBUG) { System.out.println("AssertStatement ::= assert Expression COLON Expression"); }  //$NON-NLS-1$
		    consumeAssertStatement() ;
			break;

    case 466 : if (DEBUG) { System.out.println("BreakStatement ::= break SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementBreak() ;
			break;

    case 467 : if (DEBUG) { System.out.println("BreakStatement ::= break Identifier SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementBreakWithLabel() ;
			break;

    case 468 : if (DEBUG) { System.out.println("ContinueStatement ::= continue SEMICOLON"); }  //$NON-NLS-1$
    ...
    case 471 : if (DEBUG) { System.out.println("YieldReturnStatement ::= yieldr Expressionopt SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementYieldReturn() ;
			break;

    case 472 : if (DEBUG) { System.out.println("NonLocalStatement ::= nonlocal Expressionopt SEMICOLON"); }  //$NON-NLS-1$
		    consumeStatementNonLocal() ;
			break;
    ...
    case 478 : if (DEBUG) { System.out.println("TryStatement ::= try TryBlock Catches else Block"); }  //$NON-NLS-1$
		    consumeStatementTryWithElse(false, false);
			break;
    ...
    case 480 : if (DEBUG) { System.out.println("TryStatement ::= try TryBlock Catchesopt Finally else..."); }  //$NON-NLS-1$
		    consumeStatementTryWithElse(true, false);
			break;
    ...
    case 482 : if (DEBUG) { System.out.println("TryStatementWithResources ::= try ResourceSpecification"); }  //$NON-NLS-1$
		    consumeStatementTryWithElse(false, true);
			break;
    ...
    case 484 : if (DEBUG) { System.out.println("TryStatementWithResources ::= try ResourceSpecification"); }  //$NON-NLS-1$
		    consumeStatementTryWithElse(true, true);
			break;
    ...
    case 494 : if (DEBUG) { System.out.println("Resource ::= FieldAccess"); }  //$NON-NLS-1$
		    consumeResourceAsFieldAccess();
			break;

    case 496 : if (DEBUG) { System.out.println("ExitTryBlock ::="); }  //$NON-NLS-1$
		    consumeExitTryBlock();
			break;

    case 498 : if (DEBUG) { System.out.println("Catches ::= Catches CatchClause"); }  //$NON-NLS-1$
		    consumeCatches();
			break;

    case 499 : if (DEBUG) { System.out.println("CatchClause ::= catch LPAREN CatchFormalParameter RPAREN"); }  //$NON-NLS-1$
		    consumeStatementCatch() ;
			break;

    case 501 : if (DEBUG) { System.out.println("PushLPAREN ::= LPAREN"); }  //$NON-NLS-1$
		    consumeLeftParen();
			break;

    case 502 : if (DEBUG) { System.out.println("PushRPAREN ::= RPAREN"); }  //$NON-NLS-1$
		    consumeRightParen();
			break;

    case 507 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= this"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayThis();
			break;

    case 508 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= PushLPAREN Expression_NotName..."); }  //$NON-NLS-1$
		    consumePrimaryNoNewArray();
			break;

    case 509 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= PushLPAREN Name PushRPAREN"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayWithName();
			break;

    case 512 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= Name DOT this"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayNameThis();
			break;

    case 513 : if (DEBUG) { System.out.println("QualifiedSuperReceiver ::= Name DOT super"); }  //$NON-NLS-1$
		    consumeQualifiedSuperReceiver();
			break;

    case 514 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= Name DOT class"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayName();
			break;

    case 515 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= Name Dims DOT class"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayArrayType();
			break;

    case 516 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= PrimitiveType Dims DOT class"); }  //$NON-NLS-1$
		    consumePrimaryNoNewArrayPrimitiveArrayType();
			break;

    case 517 : if (DEBUG) { System.out.println("PrimaryNoNewArray ::= PrimitiveType DOT class"); }  //$NON-NLS-1$
    ...
    case 582 : if (DEBUG) { System.out.println("FieldAccess ::= QualifiedSuperReceiver DOT Identifier"); }  //$NON-NLS-1$
		    consumeFieldAccess(false);
			break;

    case 583 : if (DEBUG) { System.out.println("MethodInvocation ::= Name LPAREN ArgumentListopt RPAREN"); }  //$NON-NLS-1$
		    consumeMethodInvocationName();
			break;

    case 584 : if (DEBUG) { System.out.println("MethodInvocation ::= Name DOT OnlyTypeArguments..."); }  //$NON-NLS-1$
		    consumeMethodInvocationNameWithTypeArguments();
			break;

    case 585 : if (DEBUG) { System.out.println("MethodInvocation ::= Primary DOT OnlyTypeArguments..."); }  //$NON-NLS-1$
		    consumeMethodInvocationPrimaryWithTypeArguments();
			break;

    case 586 : if (DEBUG) { System.out.println("MethodInvocation ::= Primary DOT Identifier LPAREN..."); }  //$NON-NLS-1$
		    consumeMethodInvocationPrimary();
			break;

    case 587 : if (DEBUG) { System.out.println("MethodInvocation ::= QualifiedSuperReceiver DOT..."); }  //$NON-NLS-1$
		    consumeMethodInvocationPrimary();
			break;
    ...
    case 589 : if (DEBUG) { System.out.println("MethodInvocation ::= super DOT OnlyTypeArguments..."); }  //$NON-NLS-1$
		    consumeMethodInvocationSuperWithTypeArguments();
			break;

    case 590 : if (DEBUG) { System.out.println("MethodInvocation ::= super DOT Identifier LPAREN..."); }  //$NON-NLS-1$
		    consumeMethodInvocationSuper();
			break;

    case 591 : if (DEBUG) { System.out.println("ArrayAccess ::= Name LBRACKET Expression RBRACKET"); }  //$NON-NLS-1$
		    consumeArrayAccess(true);
			break;

    case 592 : if (DEBUG) { System.out.println("ArrayAccess ::= PrimaryNoNewArray LBRACKET Expression..."); }  //$NON-NLS-1$
		    consumeArrayAccess(false);
			break;

    case 593 : if (DEBUG) { System.out.println("ArrayAccess ::= ArrayCreationWithArrayInitializer..."); }  //$NON-NLS-1$
		    consumeArrayAccess(false);
			break;

    case 595 : if (DEBUG) { System.out.println("PostfixExpression ::= Name"); }  //$NON-NLS-1$
		    consumePostfixExpression();
			break;

    case 598 : if (DEBUG) { System.out.println("PostIncrementExpression ::= PostfixExpression PLUS_PLUS"); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.PLUS,true);
			break;

    case 599 : if (DEBUG) { System.out.println("PostDecrementExpression ::= PostfixExpression..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.MINUS,true);
			break;

    case 600 : if (DEBUG) { System.out.println("PushPosition ::="); }  //$NON-NLS-1$
		    consumePushPosition();
			break;

    case 603 : if (DEBUG) { System.out.println("UnaryExpression ::= PLUS PushPosition UnaryExpression"); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.PLUS);
			break;

    case 604 : if (DEBUG) { System.out.println("UnaryExpression ::= MINUS PushPosition UnaryExpression"); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.MINUS);
			break;

    case 606 : if (DEBUG) { System.out.println("PreIncrementExpression ::= PLUS_PLUS PushPosition..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.PLUS,false);
			break;

    case 607 : if (DEBUG) { System.out.println("PreDecrementExpression ::= MINUS_MINUS PushPosition..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.MINUS,false);
			break;

    case 609 : if (DEBUG) { System.out.println("UnaryExpressionNotPlusMinus ::= TWIDDLE PushPosition..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.TWIDDLE);
			break;

    case 610 : if (DEBUG) { System.out.println("UnaryExpressionNotPlusMinus ::= NOT PushPosition..."); }  //$NON-NLS-1$
		    consumeUnaryExpression(OperatorIds.NOT);
			break;

    case 612 : if (DEBUG) { System.out.println("CastExpression ::= PushLPAREN PrimitiveType Dimsopt..."); }  //$NON-NLS-1$
    ...
    case 615 : if (DEBUG) { System.out.println("CastExpression ::= PushLPAREN Name PushRPAREN..."); }  //$NON-NLS-1$
		    consumeCastExpressionLL1();
			break;

    case 616 : if (DEBUG) { System.out.println("CastExpression ::= BeginIntersectionCast PushLPAREN..."); }  //$NON-NLS-1$
		    consumeCastExpressionLL1WithBounds();
			break;

    case 617 : if (DEBUG) { System.out.println("CastExpression ::= PushLPAREN Name Dims..."); }  //$NON-NLS-1$
		    consumeCastExpressionWithNameArray();
			break;

    case 618 : if (DEBUG) { System.out.println("AdditionalBoundsListOpt ::="); }  //$NON-NLS-1$
    ...
    case 625 : if (DEBUG) { System.out.println("InsideCastExpressionLL1WithBounds ::="); }  //$NON-NLS-1$
		    consumeInsideCastExpressionLL1WithBounds ();
			break;

    case 626 : if (DEBUG) { System.out.println("InsideCastExpressionWithQualifiedGenerics ::="); }  //$NON-NLS-1$
    ...
    case 632 : if (DEBUG) { System.out.println("AdditiveExpression ::= AdditiveExpression PLUS..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.PLUS);
			break;

    case 633 : if (DEBUG) { System.out.println("AdditiveExpression ::= AdditiveExpression MINUS..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.MINUS);
			break;

    case 635 : if (DEBUG) { System.out.println("ShiftExpression ::= ShiftExpression LEFT_SHIFT..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.LEFT_SHIFT);
			break;

    case 636 : if (DEBUG) { System.out.println("ShiftExpression ::= ShiftExpression RIGHT_SHIFT..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.RIGHT_SHIFT);
			break;

    case 637 : if (DEBUG) { System.out.println("ShiftExpression ::= ShiftExpression UNSIGNED_RIGHT_SHIFT"); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.UNSIGNED_RIGHT_SHIFT);
			break;

    case 639 : if (DEBUG) { System.out.println("RelationalExpression ::= RelationalExpression LESS..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.LESS);
			break;

    case 640 : if (DEBUG) { System.out.println("RelationalExpression ::= RelationalExpression GREATER..."); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.GREATER);
			break;

    case 641 : if (DEBUG) { System.out.println("RelationalExpression ::= RelationalExpression LESS_EQUAL"); }  //$NON-NLS-1$
		    consumeBinaryExpression(OperatorIds.LESS_EQUAL);
			break;

    case 642 : if (DEBUG) { System.out.println("RelationalExpression ::= RelationalExpression..."); }  //$NON-NLS-1$
    ...
    case 647 : if (DEBUG) { System.out.println("InExpression ::= InExpression in EqualityExpression"); }  //$NON-NLS-1$
		    consumeInExpression();
			break;

    case 649 : if (DEBUG) { System.out.println("NotInExpression ::= NotInExpression not in InExpression"); }  //$NON-NLS-1$
		    consumeNotInExpression();
			break;

    case 651 : if (DEBUG) { System.out.println("TupleExpression ::= TupleExpression pyjavatuple..."); }  //$NON-NLS-1$
		    consumeTuple();
			break;

    case 653 : if (DEBUG) { System.out.println("AndExpression ::= AndExpression AND TupleExpression"); }  //$NON-NLS-1$
    ...
    case 664 : if (DEBUG) { System.out.println("ConditionalExpression ::= TupleExpression..."); }  //$NON-NLS-1$
		    consumeGenerators() ;
			break;

    case 665 : if (DEBUG) { System.out.println("ConditionalExpression ::= TupleExpression..."); }  //$NON-NLS-1$
		    consumeDickComp() ;
			break;

    case 666 : if (DEBUG) { System.out.println("GeneratorHeader ::= EnhancedForStatementHeaderInit COLON"); }  //$NON-NLS-1$
		    consumeGeneratorHeaderWithoutIf() ;
			break;

    case 667 : if (DEBUG) { System.out.println("GeneratorHeader ::= EnhancedForStatementHeaderInit COLON"); }  //$NON-NLS-1$
		    consumeGeneratorHeaderWithIf() ;
			break;

    case 668 : if (DEBUG) { System.out.println("GeneratorHeader_List ::= GeneratorHeader"); }  //$NON-NLS-1$
		    consumeGeneratorHeader();
			break;
    ...
    case 677 : if (DEBUG) { System.out.println("AssignmentOperator ::= POWER_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(POWER);
			break;

    case 678 : if (DEBUG) { System.out.println("AssignmentOperator ::= DIVIDE_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(DIVIDE);
			break;

    case 679 : if (DEBUG) { System.out.println("AssignmentOperator ::= REMAINDER_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(REMAINDER);
			break;

    case 680 : if (DEBUG) { System.out.println("AssignmentOperator ::= PLUS_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(PLUS);
			break;

    case 681 : if (DEBUG) { System.out.println("AssignmentOperator ::= MINUS_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(MINUS);
			break;

    case 682 : if (DEBUG) { System.out.println("AssignmentOperator ::= LEFT_SHIFT_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(LEFT_SHIFT);
			break;

    case 683 : if (DEBUG) { System.out.println("AssignmentOperator ::= RIGHT_SHIFT_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(RIGHT_SHIFT);
			break;

    case 684 : if (DEBUG) { System.out.println("AssignmentOperator ::= UNSIGNED_RIGHT_SHIFT_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(UNSIGNED_RIGHT_SHIFT);
			break;

    case 685 : if (DEBUG) { System.out.println("AssignmentOperator ::= AND_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(AND);
			break;

    case 686 : if (DEBUG) { System.out.println("AssignmentOperator ::= XOR_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(XOR);
			break;

    case 687 : if (DEBUG) { System.out.println("AssignmentOperator ::= OR_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(OR);
			break;

    case 688 : if (DEBUG) { System.out.println("Expression ::= AssignmentExpression"); }  //$NON-NLS-1$
		    consumeExpression();
			break;

    case 691 : if (DEBUG) { System.out.println("Expressionopt ::="); }  //$NON-NLS-1$
		    consumeEmptyExpression();
			break;

    case 694 : if (DEBUG) { System.out.println("ConstantExpressions ::= ConstantExpressions COMMA..."); }  //$NON-NLS-1$
    ...
    case 752 : if (DEBUG) { System.out.println("EnhancedForStatementWithElse ::=..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatementWithElse();
			break;

    case 753 : if (DEBUG) { System.out.println("EnhancedForStatementWithElse ::=..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatementWithElse();
			break;

    case 754 : if (DEBUG) { System.out.println("EnhancedForStatementNoShortIfWithElse ::=..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatementWithElse();
			break;

    case 755 : if (DEBUG) { System.out.println("EnhancedForStatementNoShortIfWithElse ::=..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatementWithElse();
			break;

    case 756 : if (DEBUG) { System.out.println("EnhancedForStatement ::= EnhancedForStatementHeader..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatement();
			break;

    case 757 : if (DEBUG) { System.out.println("EnhancedForStatementNoShortIf ::=..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatement();
			break;

    case 761 : if (DEBUG) { System.out.println("EnhancedForStatementHeaderInit ::= for LPAREN..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatementHeaderInit(false);
			break;

    case 762 : if (DEBUG) { System.out.println("EnhancedForStatementHeaderInit ::= for LPAREN Modifiers"); }  //$NON-NLS-1$
		    consumeEnhancedForStatementHeaderInit(true);
			break;

    case 763 : if (DEBUG) { System.out.println("EnhancedForStatementHeaderInit ::= for..."); }  //$NON-NLS-1$
		    consumeGenEnhancedForStatementHeaderInit();
			break;
    ...
    case 867 : if (DEBUG) { System.out.println("InstanceofExpression_NotName ::= Name instanceof..."); }  //$NON-NLS-1$
    ...
    case 875 : if (DEBUG) { System.out.println("InExpression_NotName ::= InExpression_NotName in..."); }  //$NON-NLS-1$
		    consumeInExpression();
			break;

    case 876 : if (DEBUG) { System.out.println("InExpression_NotName ::= Name in EqualityExpression"); }  //$NON-NLS-1$
		    consumeInExpressionWithName();
			break;

    case 878 : if (DEBUG) { System.out.println("NotInExpression_NotName ::= NotInExpression_NotName not"); }  //$NON-NLS-1$
		    consumeNotInExpression();
			break;

    case 879 : if (DEBUG) { System.out.println("NotInExpression_NotName ::= Name not in InExpression"); }  //$NON-NLS-1$
		    consumeNotInExpressionWithName();
			break;

    case 881 : if (DEBUG) { System.out.println("TupleExpression_NotName ::= TupleExpression_NotName..."); }  //$NON-NLS-1$
		    consumeTuple();
			break;

    case 882 : if (DEBUG) { System.out.println("TupleExpression_NotName ::= Name pyjavatuple..."); }  //$NON-NLS-1$
		    consumeTupleWithName();
			break;
    ...
    case 885 : if (DEBUG) { System.out.println("AndExpression_NotName ::= Name AND TupleExpression"); }  //$NON-NLS-1$
...
//        }
    ...
    */
    ...
    protected void consumeStatementNonLocal(){
        if (this.expressionLengthStack[this.expressionLengthPtr--] != 0) {
            pushOnAstStack(
                    new NonLocalStatement(
                            this.expressionStack[this.expressionPtr--],
                            this.intStack[this.intPtr--],
                            this.endStatementPosition)
            );
        } else {
            pushOnAstStack(new NonLocalStatement(null, this.intStack[this.intPtr--], this.endStatementPosition));
        }
    ...
    protected void consumeStatementYieldReturn(){
//        PyYieldReturnStatement ::= 'yield' Expressionopt ';'
        ...
        if (this.expressionLengthStack[this.expressionLengthPtr--] != 0) {
            ...
            pushOnAstStack(new YieldReturnStatement(null, this.intStack[this.intPtr--], this.endStatementPosition));
        }
    }
    ...
    protected void consumeStatementTryWithElse(boolean withFinally, boolean hasResources){
        ...
        this.astLengthPtr--;
        tryStmt.elseBlock = (Block) this.astStack[this.astPtr--];
