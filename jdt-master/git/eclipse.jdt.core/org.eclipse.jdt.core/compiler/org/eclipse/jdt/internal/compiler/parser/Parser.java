...
protected void consumeRule(int act) {
 ...
 consumeMethodDeclaration(false, false);
    ...
    case 670 : if (DEBUG) { System.out.println("ConditionalExpression ::= TupleExpression..."); }  //$NON-NLS-1$
		    consumeDickCompWithIF() ;
			break;

    case 671 : if (DEBUG) { System.out.println("ConditionalExpression ::= TupleExpression..."); }  //$NON-NLS-1$
		    consumeDickCompWithoutIF() ;
			break;
    ...
    case 679 : if (DEBUG) { System.out.println("AssignmentOperator ::= DIVIDE_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(DIVIDE);
			break;

    case 680 : if (DEBUG) { System.out.println("AssignmentOperator ::= REMAINDER_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(REMAINDER);
			break;

    case 681 : if (DEBUG) { System.out.println("AssignmentOperator ::= PLUS_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(PLUS);
			break;

    case 682 : if (DEBUG) { System.out.println("AssignmentOperator ::= MINUS_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(MINUS);
			break;

    case 683 : if (DEBUG) { System.out.println("AssignmentOperator ::= LEFT_SHIFT_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(LEFT_SHIFT);
			break;

    case 684 : if (DEBUG) { System.out.println("AssignmentOperator ::= RIGHT_SHIFT_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(RIGHT_SHIFT);
			break;

    case 685 : if (DEBUG) { System.out.println("AssignmentOperator ::= UNSIGNED_RIGHT_SHIFT_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(UNSIGNED_RIGHT_SHIFT);
			break;

    case 686 : if (DEBUG) { System.out.println("AssignmentOperator ::= AND_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(AND);
			break;

    case 687 : if (DEBUG) { System.out.println("AssignmentOperator ::= XOR_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(XOR);
			break;

    case 688 : if (DEBUG) { System.out.println("AssignmentOperator ::= OR_EQUAL"); }  //$NON-NLS-1$
		    consumeAssignmentOperator(OR);
			break;

    case 689 : if (DEBUG) { System.out.println("Expression ::= AssignmentExpression"); }  //$NON-NLS-1$
		    consumeExpression();
			break;

    case 692 : if (DEBUG) { System.out.println("Expressionopt ::="); }  //$NON-NLS-1$
		    consumeEmptyExpression();
			break;

    case 695 : if (DEBUG) { System.out.println("ConstantExpressions ::= ConstantExpressions COMMA..."); }  //$NON-NLS-1$
    ...
    case 762 : if (DEBUG) { System.out.println("EnhancedForStatementHeaderInit ::= for LPAREN..."); }  //$NON-NLS-1$
		    consumeEnhancedForStatementHeaderInit(false);
			break;

    case 763 : if (DEBUG) { System.out.println("EnhancedForStatementHeaderInit ::= for LPAREN Modifiers"); }  //$NON-NLS-1$
		    consumeEnhancedForStatementHeaderInit(true);
			break;

    case 764 : if (DEBUG) { System.out.println("EnhancedForStatementHeaderInit ::= for..."); }  //$NON-NLS-1$
    ...
    case 868 : if (DEBUG) { System.out.println("InstanceofExpression_NotName ::= Name instanceof..."); }  //$NON-NLS-1$
    ...
    case 876 : if (DEBUG) { System.out.println("InExpression_NotName ::= InExpression_NotName in..."); }  //$NON-NLS-1$
		    consumeInExpression();
			break;

    case 877 : if (DEBUG) { System.out.println("InExpression_NotName ::= Name in EqualityExpression"); }  //$NON-NLS-1$
		    consumeInExpressionWithName();
			break;

    case 879 : if (DEBUG) { System.out.println("NotInExpression_NotName ::= NotInExpression_NotName not"); }  //$NON-NLS-1$
		    consumeNotInExpression();
			break;

    case 880 : if (DEBUG) { System.out.println("NotInExpression_NotName ::= Name not in InExpression"); }  //$NON-NLS-1$
		    consumeNotInExpressionWithName();
			break;

    case 882 : if (DEBUG) { System.out.println("TupleExpression_NotName ::= TupleExpression_NotName..."); }  //$NON-NLS-1$
		    consumeTuple();
			break;

    case 883 : if (DEBUG) { System.out.println("TupleExpression_NotName ::= Name pyjavatuple..."); }  //$NON-NLS-1$
    ...
    case 886 : if (DEBUG) { System.out.println("AndExpression_NotName ::= Name AND TupleExpression"); }  //$NON-NLS-1$
