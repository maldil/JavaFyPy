...
public abstract class ASTNode {
	...
	/**
	 * Start positions of Python nodes hast to change because of the augmented python ast
	 */
	...
	public class NodeList extends AbstractList {
		 ...
		 * @since 3.0
		 */
		public NodeList(ChildListPropertyDescriptor property) {
			super();
	...
	public final int getPyStartPosition() {
		return this.pyStartPosition;
	}
